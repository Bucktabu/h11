...
securityRouter.get('/devices',
    refreshTokenValidation, securityControllerInstance.getAllActiveSessions)

securityRouter.delete('/devices',
    refreshTokenValidation, securityControllerInstance.deleteAllActiveSessions)

securityRouter.delete('/devices/:deviceId',
    refreshTokenValidation, securityControllerInstance.deleteActiveSessionsById)